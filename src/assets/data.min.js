...
const data = {
	...
	Home: {
		name: "FLARE 2025",
		introduction:
			"Fast, Low-resource, and Accurate Robust and Pan-Effectual Medical Image Analysis",
	...
	Task5: {
		name: "TASK 5",
		title: "Multimodal Model for Medical Image Parsing Foundation Model for 3D CT and MRI scans",
		image: "task5.png",
		keywords: [
			{
				animationClass: "Right left",
